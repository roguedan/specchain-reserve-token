...
*This report was generated automatically on 2026-03-15. For questions or clarifications, please refer to the project documentation.*
## Appendix A: Test Results
```
Compiling 25 files with Solc 0.8.20
Solc 0.8.20 finished in 946.78ms
...
Suite result: ok. 10 passed; 0 failed; 0 skipped; finished in 1.27ms (771.19µs CPU time)
...
Suite result: ok. 3 passed; 0 failed; 0 skipped; finished in 499.79µs (230.15µs CPU time)
...
Suite result: ok. 29 passed; 0 failed; 0 skipped; finished in 3.64ms (2.40ms CPU time)
...
Suite result: ok. 22 passed; 0 failed; 0 skipped; finished in 6.35ms (5.24ms CPU time)

Ran 5 tests for tests/ReserveRequirement.fuzz.t.sol:ReserveRequirementFuzzTest
[PASS] testFuzz_MintAmount(uint256) (runs: 256, μ: 73381, ~: 71832)
[PASS] testFuzz_MultipleOperations(uint256[5],address[5],uint256) (runs: 256, μ: 250619, ~: 252798)
[PASS] testFuzz_ReserveManipulation(uint256) (runs: 256, μ: 140077, ~: 141288)
[PASS] testFuzz_Transfer(address,address,uint256,uint256) (runs: 256, μ: 92333, ~: 82689)
[PASS] testFuzz_TransferFrom(address,address,address,uint256,uint256) (runs: 256, μ: 118913, ~: 123380)
Suite result: ok. 5 passed; 0 failed; 0 skipped; finished in 77.64ms (230.32ms CPU time)

Ran 5 test suites in 78.27ms (89.40ms CPU time): 69 tests passed, 0 failed, 0 skipped (69 total tests)
```
...
[PASS] testTransferFromPartialAllowance() (gas: 139040)
[PASS] testZeroAmountTransfer() (gas: 86210)
Suite result: ok. 29 passed; 0 failed; 0 skipped; finished in 10.20ms (14.13ms CPU time)
...
[PASS] testTransferUnderflow() (gas: 27429)
[PASS] testZeroTransfer() (gas: 34260)
Suite result: ok. 10 passed; 0 failed; 0 skipped; finished in 4.19ms (3.46ms CPU time)

Ran 3 tests for tests/ReserveRequirement.t.sol:ReserveRequirementTest
[PASS] testMintGatedByCoverage() (gas: 98032)
[PASS] testTransferRevertsWhenReserveBelowSupply() (gas: 60233)
[PASS] testTransferSucceedsWhenReserveCoversSupply() (gas: 53603)
Suite result: ok. 3 passed; 0 failed; 0 skipped; finished in 999.24µs (574.70µs CPU time)
...
[PASS] testTransferToZeroAddress() (gas: 104907)
[PASS] testZeroValueOperations() (gas: 52009)
Suite result: ok. 22 passed; 0 failed; 0 skipped; finished in 111.52ms (13.64ms CPU time)
...
Suite result: ok. 5 passed; 0 failed; 0 skipped; finished in 121.07ms (335.24ms CPU time)

Ran 5 test suites in 121.70ms (247.98ms CPU time): 69 tests passed, 0 failed, 0 skipped (69 total tests)
